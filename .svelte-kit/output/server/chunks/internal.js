...
function create_effect(type, fn, sync, push2 = true) {
  ...
  if (!inert && !is_root && push2) {
    ...
    if (active_reaction !== null && (active_reaction.f & DERIVED) !== 0) {
      ...
      ((_a = derived.effects) != null ? _a : derived.effects = []).push(effect2);
    }
  }
  return effect2;
}
    ...
    if (new_deps !== null) {
      ...
      if (!skip_reaction) {
        for (i = skipped_deps; i < deps.length; i++) {
          ((_b = (_a = deps[i]).reactions) != null ? _b : _a.reactions = []).push(reaction);
        }
      }
...
function hydrate(component, options2) {
  var _a;
  init_operations();
  options2.intro = (_a = options2.intro) != null ? _a : false;
  ...
  try {
    ...
    hydrate_next();
    const instance = _mount(component, __spreadProps(__spreadValues({}, options2), { anchor }));
...
class Svelte4Component {
  ...
  constructor(options2) {
    ...
    const props = new Proxy(
      __spreadProps(__spreadValues({}, options2.props || {}), { $$events: {} }),
      {
        get(target, prop) {
          var _a2;
          return get((_a2 = sources.get(prop)) != null ? _a2 : add_source(prop, Reflect.get(target, prop)));
        },
        has(target, prop) {
          var _a2;
          if (prop === LEGACY_PROPS) return true;
          get((_a2 = sources.get(prop)) != null ? _a2 : add_source(prop, Reflect.get(target, prop)));
          return Reflect.has(target, prop);
        },
        set(target, prop, value) {
          var _a2;
          set((_a2 = sources.get(prop)) != null ? _a2 : add_source(prop, value), value);
    ...
    __privateSet(this, _instance, (options2.hydrate ? hydrate : mount)(options2.component, {
      ...
      intro: (_a = options2.intro) != null ? _a : false,
      recover: options2.recover
    }));
    if (!((_b = options2 == null ? void 0 : options2.props) == null ? void 0 : _b.$$host) || options2.sync === false) {
      flush_sync();
    }
